...
function chooseContent(code){
    ...
    switch(code){
        ...
        case '3':
            ...
            탄막 슈팅형 액션 로그라이크 던전 크롤러게임인 Enter the Gungeon은 한번쯤은 해볼만한 재미있는 게임입니다.<br>";
            break;
        case '4':
        ...
        case '6':
            ...
            주의! 멀티 플레이를 적극 권장합니다, 이 게임은 dlc가 메인입니다.";
            break;
        case '7':
            H2 = "Human: Fall Flat";
            ...
            주의! 친구랑 같이하면 친구를 낭떠러지에 떨어트리는 자신의 모습을 볼 수 있음.";
            break;
        case '8':
            H2 = "Hunt: Showdown";
        ...
        case '10':
            ...
            이 게임을 통해 자신만의 농장을 가꾸고, 모험도 하고, 낚시도 하고 힐링을 즐기십시오";
            break;
        case '11':
            H2 = "HearthStone";
            ...
            하수인을 소환하고 강력한 주문을 시전하여 적 영웅을 격파하십시오!";
            break;
        case '12':
            H2 = "Slay the Spire";
            ...
            이 게임은 로그라이크 덱 빌딩 카드게임입니다. 직업을 선택하고 카드를 모으고 탐험 경로를 설정하세요. 최종적으로는 첨탑의 심장을 격파하여 엔딩을 마주하십시오.";
            break;
        case '13':
            H2 = "Portal 2";
            ...
            주의! 스토리상 포탈1을 먼저 플레이 하지 않으면 스토리 이해가 매우 힘듭니다.";
            break;
        case '14':
            ...
            이 게임을 생존자를 선택하고 무기와 패시브 아이템들을 수집하고 강화하며 괴물을 막고 최종적으로는 30분을 버티는 게임입니다.";      
            break;
        case '15':
            H2 = "For The King";
            ...
            모험을 하고, 괴물을 물리치며 장비를 수집하여 최종 보스를 쓰러트리세요!";
            break;
        case '16':
            ...
            제 4의 벽을 허물은 창의적인 퍼즐과 유쾌한 더빙으로 플레이어에게 즐거움을 선사합니다. 적극 추천!";
            break;
    }
